...
export class Initial1747332339408 implements MigrationInterface {
  name = 'Initial1747332339408';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "services" ("id" character(29) NOT NULL, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "name" character varying(255) NOT NULL, "description" character varying(2048) NOT NULL, "tenantId" character(29), CONSTRAINT "UQ_e5895dfa1e5159a47c62f1a88ce" UNIQUE ("name", "tenantId"), CONSTRAINT "PK_ba2d347a3168a296416c6c5ccb2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
